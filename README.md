...
- **Backend** - PHP, Fastify, SQL, Elixir (learinig only)
- **OS** - FreeBSD 15.0
- **IDE** - VS Code, Neovim (learning)

## Im doing now
- Object hub 0.97.4 - modern activity tab
- newHelper.js 2.2 - more modular + plugin store
- Learning Neovim - why not?
